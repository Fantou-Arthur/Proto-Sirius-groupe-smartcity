...
public class SelectIdNamePlacesClientRequest extends ClientRequest<Object, Places> {

    public SelectIdNamePlacesClientRequest(NetworkConfig networkConfig, int myBirthDate, Request request, Object info, byte[] bytes) throws IOException {
